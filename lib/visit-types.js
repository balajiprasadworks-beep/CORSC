...
export const VISIT_TYPES = {
  ...
  threeMonth: {
    ...
    sections: ["since-last-visit", "vitals", "symptoms", "examination", "investigations", "medication", "risk", "surveillance", "follow-up", "overview"],
    requiresSinceLastVisit: true,
    requiresCycle: false,
  },
  ...
  sixMonth: {
    ...
    sections: ["since-last-visit", "vitals", "symptoms", "investigations", "medication", "risk", "surveillance", "follow-up", "overview"],
    requiresSinceLastVisit: true,
    requiresCycle: false,
  },
  ...
  twelveMonth: {
    ...
    sections: ["since-last-visit", "vitals", "symptoms", "examination", "investigations", "medication", "risk", "surveillance", "follow-up", "timeline", "overview"],
    requiresSinceLastVisit: true,
    requiresCycle: false,
  },
  ...
  longTerm: {
    ...
    sections: ["since-last-visit", "vitals", "symptoms", "investigations", "medication", "risk", "surveillance", "follow-up", "timeline", "overview"],
    requiresSinceLastVisit: true,
    requiresCycle: false,
  },
};
